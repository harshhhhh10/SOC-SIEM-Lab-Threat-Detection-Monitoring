...
Crucial Troubleshooting Step: The Universal Forwarder UI did not automatically capture Sysmon logs. I manually created an inputs.conf file at C:\Program Files\SplunkUniversalForwarder\etc\system\local\inputs.conf with the following stanza to force ingestion:
[WinEventLog://Microsoft-Windows-Sysmon/Operational]disabled = 0index = main
